...
export class ProfileComponent implements OnInit {
  url:string = 'http://172.31.80.119:9999/student/info';
  ...
  update():void{
    ...
    console.log(body);
    this.http.post('http://172.31.80.119:9999/student/update', body, {'headers':headers,observe: 'response', withCredentials: true}).subscribe(
      {
